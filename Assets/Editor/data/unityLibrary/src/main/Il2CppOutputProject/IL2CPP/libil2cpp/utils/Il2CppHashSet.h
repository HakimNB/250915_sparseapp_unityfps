...
template<class Value,
         class HashFcn = SPP_NAMESPACE::spp_hash<Value>,
         class EqualKey = std::equal_to<Value>,
         class Alloc = GOOGLE_NAMESPACE::libc_allocator_with_realloc<KeyWrapper<Value> > >
#if IL2CPP_USE_SPARSEHASH
class Il2CppHashSet : public SPP_NAMESPACE::sparse_hash_set<KeyWrapper<Value>, HashFcn, typename KeyWrapper<Value>::template EqualsComparer<EqualKey>, Alloc>
#else
...
private:
#if IL2CPP_USE_SPARSEHASH
    typedef SPP_NAMESPACE::sparse_hash_set<KeyWrapper<Value>, HashFcn, typename KeyWrapper<Value>::template EqualsComparer<EqualKey>, Alloc> Base;
#else
